...
function BackgroundPanel() {
  ...
  return (
    <>
      ...
      {appBg.mode === 'upload' && <label className="field"><span>Screenshot URL of your app</span><input type="text" value={appBg.image} onChange={(e) => setAppBg({ image: e.target.value })} /></label>}
