...
function resolveBody(g: GmailState): string {
  ...
  if (g.bodyMode === 'plain')
    return buildAiEmail({ brand: g.senderName, wordmark: g.wordmark || undefined, accent: g.plain.accent, image: g.plain.image, heading: g.plain.heading, body: g.plain.body, btn: g.plain.btn, footer: g.footer })
